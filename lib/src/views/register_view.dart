        ...
        child: SafeArea(
          child: Scaffold(
            appBar: AppBar(
              ...
              title: "Register".text.uppercase.textStyle(Get.theme.textTheme.bodyLarge!.copyWith(fontSize: 18)).make(),
              centerTitle: true,
              leading: InkWell(
                onTap: () {
                  Get.offNamed('/login');
                            ...
                            children: <Widget>[
                              ...
                              mainService.loginPageData.value.privacyPolicy != ""
                                  ? mainService.loginPageData.value.privacyPolicy.text.center
                                      ...
                                      .centered()
                                      .pSymmetric(h: 20)
                                  : "By continuing you agree to $appName terms of use and confirm that you have read our privacy policy."
                                      .text
                                      .center
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  height: 40,
                                  width: Get.width,
                                  child: "Already have an account. Sign in".text.center.textStyle(Get.theme.textTheme.titleMedium).make().centered().pSymmetric(h: 10, v: 0),
                                ),
                              ),
                            ],
                          ),
